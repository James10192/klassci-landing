...
| 4495 | État, subventions d'exploitation à recevoir | La créance sur l'État, en contrepartie du compte 71, si la part de l'État est traitée en subvention (voir plus bas) |
...
Deux points à trancher avec votre expert-comptable : le rythme de la dépréciation — au bout de combien de jours une créance famille bascule en 4162, et à quel taux — et le traitement de la créance sur l'État. Compte tenu du mécanisme « n+1 », un retard de subvention n'a pas la même signification qu'un retard de famille et ne devrait pas se déprécier selon la même règle. Deux questions qui relèvent d'une politique comptable écrite, appliquée d'un exercice à l'autre. La qualification même de la part de l'État — subvention d'exploitation, ou prix de vente payé par un tiers en 4114 contre 706 — n'est tranchée par aucun texte : les deux lectures se défendent, et notre guide de la [comptabilité scolaire SYSCOHADA](/fr/blog/comptabilite-scolaire-syscohada) les compare.
