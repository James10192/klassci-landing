...
Retourne les classes filtrées par rôle. Inclut le nombre d'étudiants inscrits (uniquement les inscriptions au statut **Active**, c'est-à-dire ayant atteint la dernière étape du workflow).
...
Retourne uniquement les étudiants dont l'inscription est **Active** (workflow validé). Les inscriptions encore au stade **Prospect** ou **En validation** ne sont jamais exposées.
