...
- **Sync BTS/LMD** — re-synchronise le rattachement des matières aux classes selon les planifications académiques (utile après une mise à jour en masse des planifs).
