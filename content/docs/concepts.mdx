...
Cette page sert de **référence** pour le vocabulaire et les rôles utilisés partout dans KLASSCI. Si vous démarrez votre tenant, allez directement au [Quickstart 60 minutes](/fr/docs/getting-started) et revenez ici quand un terme vous bloque.
...
- [Quickstart 60 minutes](/fr/docs/getting-started) — le parcours linéaire pour démarrer un tenant
- [Super-administrateur — installation initiale](/fr/docs/superadmin/onboarding) — la référence détaillée étape par étape
- [Module Frais & Comptabilité](/fr/docs/modules/frais-comptabilite) — référence complète du paramétrage financier
